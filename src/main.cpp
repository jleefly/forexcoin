...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Fri, 20 Feb 2015 17:41:37 GMT";
        CTransaction txNew;
        txNew.nTime = 1424454097;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xedb1a8f47edb9070c5e93b9150ade3922636f2a34fb43bbc94f00b839829df0b"));
        block.print();
